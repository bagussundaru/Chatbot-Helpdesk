...
class BitextDataProcessor:
    """Processor untuk data Bitext Gen AI Chatbot Customer Support Dataset menjadi format training data"""
    
    def __init__(self, csv_directory: str = "./data/bitext"):
    ...
    def consolidate_dataframes(self, dataframes: List[pd.DataFrame]) -> pd.DataFrame:
        ...
        for df in dataframes:
            ...
            # Mapping kolom Bitext ke format standar
            column_mapping = {
                'ISSUE': ['instruction'],
                'EXPECTED': ['response'],
            ...
            for standard_col, possible_cols in column_mapping.items():
                for col in possible_cols:
                    if col in df.columns:
                        if standard_col == 'MENU' and col == 'category':
                            # Jika ada kolom intent, gabungkan category dan intent
                            if 'intent' in df.columns:
                                standard_df[standard_col] = df['category'] + " - " + df['intent']
                            else:
    ...
    def create_training_data(self, df: pd.DataFrame) -> List[Dict[str, Any]]:
        ...
        for _, row in df.iterrows():
            ...
            # Skip jika issue atau expected kosong
    ...
    def save_training_data(self, training_data: List[Dict[str, Any]], output_file: str = "bitext_training_data.json"):
    ...
    def process_all_data(self) -> List[Dict[str, Any]]:
        ...
        logger.info("Starting Bitext data processing...")
